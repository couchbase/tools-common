...
import (
	...
	objval "github.com/couchbase/tools-common/cloud/v8/objstore/objval"
)
...
func (_m *MockClient) AppendToObject(ctx context.Context, opts AppendToObjectOptions) (*objval.ObjectAttrs, error) {
	ret := _m.Called(ctx, opts)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, AppendToObjectOptions) (*objval.ObjectAttrs, error)); ok {
		return rf(ctx, opts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, AppendToObjectOptions) *objval.ObjectAttrs); ok {
		r0 = rf(ctx, opts)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, AppendToObjectOptions) error); ok {
		r1 = rf(ctx, opts)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *MockClient) CompleteMultipartUpload(ctx context.Context, opts CompleteMultipartUploadOptions) (*objval.ObjectAttrs, error) {
	ret := _m.Called(ctx, opts)
	...
	var r0 *objval.ObjectAttrs
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, CompleteMultipartUploadOptions) (*objval.ObjectAttrs, error)); ok {
		return rf(ctx, opts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, CompleteMultipartUploadOptions) *objval.ObjectAttrs); ok {
		r0 = rf(ctx, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*objval.ObjectAttrs)
	...
	if rf, ok := ret.Get(1).(func(context.Context, CompleteMultipartUploadOptions) error); ok {
		r1 = rf(ctx, opts)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *MockClient) CopyObject(ctx context.Context, opts CopyObjectOptions) (*objval.ObjectAttrs, error) {
	ret := _m.Called(ctx, opts)
	...
	var r0 *objval.ObjectAttrs
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, CopyObjectOptions) (*objval.ObjectAttrs, error)); ok {
		return rf(ctx, opts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, CopyObjectOptions) *objval.ObjectAttrs); ok {
		r0 = rf(ctx, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*objval.ObjectAttrs)
	...
	if rf, ok := ret.Get(1).(func(context.Context, CopyObjectOptions) error); ok {
		r1 = rf(ctx, opts)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *MockClient) DeleteObjectVersions(ctx context.Context, opts DeleteObjectVersionsOptions) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, DeleteObjectVersionsOptions) error); ok {
		r0 = rf(ctx, opts)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *MockClient) GetBucketLockingStatus(ctx context.Context, opts GetBucketLockingStatusOptions) (*objval.BucketLockingStatus, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetBucketLockingStatus")
	}

	var r0 *objval.BucketLockingStatus
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, GetBucketLockingStatusOptions) (*objval.BucketLockingStatus, error)); ok {
		return rf(ctx, opts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, GetBucketLockingStatusOptions) *objval.BucketLockingStatus); ok {
		r0 = rf(ctx, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*objval.BucketLockingStatus)
		}
	}
...
func (_m *MockClient) PutObject(ctx context.Context, opts PutObjectOptions) (*objval.ObjectAttrs, error) {
	ret := _m.Called(ctx, opts)
	...
	var r0 *objval.ObjectAttrs
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, PutObjectOptions) (*objval.ObjectAttrs, error)); ok {
		return rf(ctx, opts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, PutObjectOptions) *objval.ObjectAttrs); ok {
		r0 = rf(ctx, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*objval.ObjectAttrs)
	...
	if rf, ok := ret.Get(1).(func(context.Context, PutObjectOptions) error); ok {
		r1 = rf(ctx, opts)
	} else {
		r1 = ret.Error(1)
	}
