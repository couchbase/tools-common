...
// UploadPartCopy provides a mock function with given fields: ctx, dstBucket, id, dstKey, srcBucket, srcKey, number, br
func (_m *MockClient) UploadPartCopy(ctx context.Context, dstBucket, id, dstKey, srcBucket, srcKey string, number int, br *objval.ByteRange) (objval.Part, error) {
	ret := _m.Called(ctx, dstBucket, id, dstKey, srcBucket, srcKey, number, br)

	var r0 objval.Part
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, string, string, int, *objval.ByteRange) (objval.Part, error)); ok {
		return rf(ctx, dstBucket, id, dstKey, srcBucket, srcKey, number, br)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, string, string, int, *objval.ByteRange) objval.Part); ok {
		r0 = rf(ctx, dstBucket, id, dstKey, srcBucket, srcKey, number, br)
	} else {
		r0 = ret.Get(0).(objval.Part)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, string, string, string, string, int, *objval.ByteRange) error); ok {
		r1 = rf(ctx, dstBucket, id, dstKey, srcBucket, srcKey, number, br)
	} else {
		r1 = ret.Error(1)
	}
