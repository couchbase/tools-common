...
type mockConstructorTestingTnewMockBlobStorageAPI interface {
	mock.TestingT
	Cleanup(func())
}

// newMockBlobStorageAPI creates a new instance of mockBlobStorageAPI. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func newMockBlobStorageAPI(t mockConstructorTestingTnewMockBlobStorageAPI) *mockBlobStorageAPI {
	mock := &mockBlobStorageAPI{}
	mock.Mock.Test(t)
