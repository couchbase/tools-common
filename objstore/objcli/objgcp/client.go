...
func (c *Client) UploadPart(bucket, id, key string, number int, body io.ReadSeeker) (objval.Part, error) {
	...
	return objval.Part{ID: intermediate, Number: number}, nil
}
...
func (c *Client) AbortMultipartUpload(bucket, id, key string) error {
	// TODO (jamesl33): This should use 'DeleteDirectory'
	// TODO (jamesl33): This such accept an upload id (to be generated by 'CreateMultipartUpload')
	return nil
}
