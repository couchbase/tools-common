...
func (_m *mockObjectAPI) NewRangeReader(ctx context.Context, offset int64, length int64) (readerAPI, error) {
...
type mockConstructorTestingTnewMockObjectAPI interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockObjectAPI(t mockConstructorTestingTnewMockObjectAPI) *mockObjectAPI {
	mock := &mockObjectAPI{}
	mock.Mock.Test(t)
